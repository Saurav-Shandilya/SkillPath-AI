        ...
        <Layout>
            <div className="max-w-4xl mx-auto py-10">
                <motion.div
                    ...
                    className="mb-12"
                >
                    <h1 className="text-5xl mb-4 font-bold">What do you want to <span className="text-[#ff6b2b]">Master?</span></h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} className="space-y-2">
                            <label className="text-secondary flex items-center gap-2 mb-2 font-medium">
                                <BookOpen className="w-4 h-4 text-[#ff6b2b]" /> Course Name
                            </label>
                            <input
                                type="text"
                                placeholder="e.g. Modern Web Development"
                                className="w-full bg-[#1e2330] border border-white/10 rounded-2xl py-4 px-6 text-white text-lg focus:outline-none focus:border-[#ff6b2b] transition-colors"
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="space-y-2">
                            <label className="text-gray-400 flex items-center gap-2 mb-2 font-medium">
                                <Target className="w-4 h-4 text-[#ff6b2b]" /> Target Goal
                            </label>
                            <input
                                type="text"
                        ...
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} className="space-y-2">
                            <label className="text-gray-400 flex items-center gap-2 mb-2 font-medium">
                                <Calendar className="w-4 h-4 text-[#ff6b2b]" /> Planned Timeline (Days)
                            </label>
                            <input
                                type="number"
                                placeholder="e.g. 30"
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className="space-y-2">
                            <label className="text-gray-400 flex items-center gap-2 mb-2 font-medium">
                                <Clock className="w-4 h-4 text-[#ff6b2b]" /> Daily Learning Time (Hours)
                            </label>
                            <select
                                className="w-full bg-[#1e2330] border border-white/10 rounded-2xl py-4 px-6 text-white text-lg focus:outline-none focus:border-[#ff6b2b] transition-colors appearance-none"
                                value={formData.dailyTime}
                                onChange={(e) => setFormData({ ...formData, dailyTime: e.target.value })}
                                required
                            >
                                <option value="" className="bg-[#1e2330]">Select time</option>
                                <option value="1" className="bg-[#1e2330]">1-2 hours</option>
                                <option value="3" className="bg-[#1e2330]">3-4 hours</option>
                                <option value="5" className="bg-[#1e2330]">5+ hours</option>
                            </select>
                        </motion.div>
                    </div>
                    ...
                    <motion.button
                        ...
                        type="submit"
                        disabled={loading}
                        className="w-full dash-btn-primary rounded-2xl py-5 text-xl flex items-center justify-center gap-3 mt-10 disabled:opacity-50"
                    >
                ...
                <div className="mt-20 grid grid-cols-3 gap-8">
                    {[
                        ...
                        <motion.div
                            ...
                            className="p-6 dash-card text-center"
                        >
                            <h3 className="text-[#00d4aa] text-lg font-bold mb-1">{feature.title}</h3>
